...
using Antigravity.Ide.Editor.Messaging;
using Antigravity.Ide.Editor.Testing;
using UnityEditor;
using UnityEngine;
using MessageType = Antigravity.Ide.Editor.Messaging.MessageType;
        ...
        private static void CheckLegacyAssemblies()
        {
            ...
            try
            {
                ...
                foreach (var assembly in assemblies)
                {
                    ...
                    Debug.LogWarning($"Project contains legacy assembly that could interfere with the Antigravity Package. You should delete {relativePath}");
                }
            }
            catch (Exception)
            {
