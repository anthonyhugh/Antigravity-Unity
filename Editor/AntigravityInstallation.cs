...
using UnityEngine;
using UnityEditor;
using Antigravity.Ide.Editor.SimpleJSON;
...
namespace Antigravity.Ide.Editor
{
    internal class AntigravityInstallation : AntigravityBaseInstallation
    {
        ...
        private string GetExtensionPath()
        {
            ...
            // Check for Antigravity extensions if custom, otherwise VSTUC might be used
            // For now, let's look for "com.antigravity.ide" or fallback to VSTUC
            return Directory
...
#elif UNITY_EDITOR_OSX
			var appPath = "/Applications"; // Standard Mac Applications folder
        ...
        public override void CreateExtraFiles(string projectDirectory)
        {
            try
            {
                ...
                var enablePatch = !File.Exists(IOPath.Combine(vscodeDirectory, ".antigravitypatchdisable"));
